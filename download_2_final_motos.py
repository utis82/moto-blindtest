#!/usr/bin/env python3
"""
Recherche et télécharge les sons de 2 dernières motos depuis YouTube.
"""
import subprocess
import json
...
# Liste des 2 dernières motos
NEW_MOTOS = [
    {"manufacturer": "Norton", "model": "Commando 961", "engine": "Parallel Twin", "cylinders": "2", "year": "2018", "funFact": "La Norton Commando est une icône britannique relancée en 2010."},
    {"manufacturer": "Buell", "model": "XB12S Lightning", "engine": "V-Twin", "cylinders": "2", "year": "2009", "funFact": "Buell était la marque sportive de Harley-Davidson, connue pour son design innovant."},
]
...
for moto in NEW_MOTOS:
    ...
    filename = f"{manufacturer.lower().replace(' ', '-')}-{model.lower().replace(' ', '-').replace('/', '-')}.mp3"
...
output_json = Path('app/backend/src/add_2_final_motos.json')
